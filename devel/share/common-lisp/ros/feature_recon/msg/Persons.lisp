...
(cl:defclass <Persons> (roslisp-msg-protocol:ros-message)
  ((persons
    :reader persons
    :initarg :persons
    :type (cl:vector feature_recon-msg:Person)
   :initform (cl:make-array 0 :element-type 'feature_recon-msg:Person :initial-element (cl:make-instance 'feature_recon-msg:Person)))
   (image_w
    :reader image_w
    :initarg :image_w
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <Persons>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Persons)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name feature_recon-msg:<Persons> is deprecated: use feature_recon-msg:Persons instead.")))

(cl:ensure-generic-function 'persons-val :lambda-list '(m))
(cl:defmethod persons-val ((m <Persons>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader feature_recon-msg:persons-val is deprecated.  Use feature_recon-msg:persons instead.")
  (persons m))

(cl:ensure-generic-function 'image_w-val :lambda-list '(m))
(cl:defmethod image_w-val ((m <Persons>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader feature_recon-msg:image_w-val is deprecated.  Use feature_recon-msg:image_w instead.")
  (image_w m))

(cl:ensure-generic-function 'image_h-val :lambda-list '(m))
(cl:defmethod image_h-val ((m <Persons>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader feature_recon-msg:image_h-val is deprecated.  Use feature_recon-msg:image_h instead.")
  (image_h m))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Persons>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader feature_recon-msg:header-val is deprecated.  Use feature_recon-msg:header instead.")
  (header m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Persons>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'persons)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'feature_recon-msg:Person))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Persons>)))
  ...
  (cl:format cl:nil "Person[] persons~%uint32 image_w~%uint32 image_h~%Header header~%================================================================================~%MSG: feature_recon/Person~%BodyPartElm[] body_part~%~%================================================================================~%MSG: feature_recon/BodyPartElm~%uint32 part_id~%float32 x~%float32 y~%float32 z~%float32 confidence~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Persons)))
  "Returns full string definition for message of type 'Persons"
  (cl:format cl:nil "Person[] persons~%uint32 image_w~%uint32 image_h~%Header header~%================================================================================~%MSG: feature_recon/Person~%BodyPartElm[] body_part~%~%================================================================================~%MSG: feature_recon/BodyPartElm~%uint32 part_id~%float32 x~%float32 y~%float32 z~%float32 confidence~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
